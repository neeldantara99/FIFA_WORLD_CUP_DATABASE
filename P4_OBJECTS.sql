...
SELECT 'Top Scorer ID: ' + CAST(@PlayerID AS VARCHAR) AS TopScorerID,
       'Total Goals: ' + CAST(@TotalGoals AS VARCHAR) AS TotalGoals;
...
EXEC GetMatchByDate
    @MatchDate = '2022-06-10', -- Provide the match date you want to search for
